from app.api.v1.endpoints import auth, impressao, itens_mesa, mesas, produtos, vendas

from fastapi import APIRouter, Depends

from app.api.v1.endpoints import auth, impressao, itens_mesa, mesas, produtos
